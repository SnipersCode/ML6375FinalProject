...
class DDQLModel:
    ...
    def build(self, name: str, show_summary=False):
        input_layer = layers.Input(
            shape=(*Constants.FRAME_SHAPE, HyperParams.PROCESS_HISTORY_LEN),
            name='input_layer')
        ...
        advantage_output_layer = layers.Dense(self.actions,
                                              kernel_initializer=keras.initializers.VarianceScaling(scale=2.),
                                              name="advantage_output")(flattened_advantage_stream)
